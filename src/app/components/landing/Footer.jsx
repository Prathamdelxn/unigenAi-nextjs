...
//                     <p>© {new Date().getFullYear()} UniGen AI. All rights reserved. ✨</p>
//                 </div>
//             </div>
//         </motion.footer>
//     );
...
export default function Footer() {
    ...
    const handleSubmit = (e) => {
        ...
        emailjs.sendForm(
            'service_pjzh8uk', // 🔁 Replace with your actual Service ID
            'template_l3y5g9w', // 🔁 Replace with your actual Template ID
            formRef.current,
            'jWReQbXKjKE7y7YBg' // 🔁 Replace with your actual Public Key
        )
        .then((result) => {
